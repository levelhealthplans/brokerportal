...
const HUBSPOT_LOCAL_FIELD_OPTIONS = [
  ...
  { key: "census_latest_hubspot_file_id", label: "Census Latest HubSpot File ID" },
  { key: "census_latest_file_url", label: "Census Latest File URL" },
  { key: "member_level_census", label: "Member Level Census (HubSpot File ID)" },
  { key: "member_level_census_url", label: "Member Level Census (URL)" },
