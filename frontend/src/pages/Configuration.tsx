...
const HUBSPOT_LOCAL_FIELD_OPTIONS = [
  ...
  { key: "member_level_census", label: "Member Level Census" },
  { key: "sbc_file", label: "SBC File" },
  { key: "current_pricing_file", label: "Current Pricing File" },
  { key: "renewal_file", label: "Renewal File" },
  { key: "high_cost_claimant_report_file", label: "High Cost Claimant Report File" },
  { key: "aggregate_report_file", label: "Aggregate Report File" },
  { key: "other_claims_data_file", label: "Other Claims Data File" },
  { key: "other_files_file", label: "Other Files File" },
  ...
  { key: "primary_network", label: "Primary Network" },
  { key: "secondary_network", label: "Secondary Network" },
  { key: "tpa", label: "TPA" },
  { key: "stoploss", label: "Stoploss" },
  { key: "current_carrier", label: "Current Carrier" },
  { key: "renewal_comparison", label: "Renewal Comparison" },
